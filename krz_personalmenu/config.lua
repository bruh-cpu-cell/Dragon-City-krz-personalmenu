...
Config.Animations = {
	...
	},
	{
		...
		items = {
			...
			{label = "Depresso", type = "attitude", data = {lib = "move_m@depressed@a", anim = "move_m@depressed@a"}},
			{label = "Depresso F", type = "attitude", data = {lib = "move_f@depressed@a", anim = "move_f@depressed@a"}},
			{label = "Uomo d'affari", type = "attitude", data = {lib = "move_m@business@a", anim = "move_m@business@a"}},
			...
			{label = "Pesante", type = "attitude", data = {lib = "move_m@fat@a", anim = "move_m@fat@a"}},
			{label = "Hipster", type = "attitude", data = {lib = "move_m@hipster@a", anim = "move_m@hipster@a"}},
			{label = "Ferito", type = "attitude", data = {lib = "move_m@injured", anim = "move_m@injured"}},
			{label = "Impaurito", type = "attitude", data = {lib = "move_m@hurry@a", anim = "move_m@hurry@a"}},
			{label = "Barbone", type = "attitude", data = {lib = "move_m@hobo@a", anim = "move_m@hobo@a"}},
			{label = "Sfortunato", type = "attitude", data = {lib = "move_m@sad@a", anim = "move_m@sad@a"}},
			{label = "Muscoloso", type = "attitude", data = {lib = "move_m@muscle@a", anim = "move_m@muscle@a"}},
			{label = "Menefreghista", type = "attitude", data = {lib = "move_m@shocked@a", anim = "move_m@shocked@a"}},
			{label = "Triste", type = "attitude", data = {lib = "move_m@shadyped@a", anim = "move_m@shadyped@a"}},
			{label = "Affaticato", type = "attitude", data = {lib = "move_m@buzzed", anim = "move_m@buzzed"}},
			{label = "Frettoloso", type = "attitude", data = {lib = "move_m@hurry_butch@a", anim = "move_m@hurry_butch@a"}},
			{label = "Fiero", type = "attitude", data = {lib = "move_m@money", anim = "move_m@money"}},
			{label = "Corsetta", type = "attitude", data = {lib = "move_m@quick", anim = "move_m@quick"}},
			{label = "Drag Queen", type = "attitude", data = {lib = "move_f@maneater", anim = "move_f@maneater"}},
